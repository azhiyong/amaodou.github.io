...
4. 创建 kiskstart 配置
    ...
    ```bash
    [root@localhost ~]# cat > /var/www/html/ubuntu16.04/ks.cfg << EOF
    ...
    timezone Asia/Shanghai
    #Root password
    rootpw --iscrypted $1$5pxRdkxE$y7g4oFFSum.A3aZ.X72TY0
    #Initial user
    user ubuntu --fullname "ubuntu" --iscrypted --password $1$5P7prhFN$yKxEnRyawaGZAqxgpD1ht/
    ...
    install
    #Use Web installation
    url --url http://192.168.56.101/ubuntu16.04
